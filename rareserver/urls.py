...
from rareserverapi.views import CategoryView, CommentView, PostView, ProfileView, SubscriptionView, ReactionView, MemberView

from django.contrib import admin
from django.conf.urls import include
from django.urls import path
from rareserverapi.views import register_user, login_user, TagView
...
router.register(r'tags', TagView, 'comment')
